...
const styles = StyleSheet.create({
  ...
  summaryLeft: { gap: 4 },
  summaryMonth: { fontSize: 18, fontWeight: '700', color: '#fff' },
  summaryLabel: { fontSize: 13, color: 'rgba(255,255,255,0.8)' },
  summaryRight: { flexDirection: 'row', alignItems: 'flex-end', gap: 4 },
  summaryCount: { fontSize: 40, fontWeight: '800', color: '#fff', lineHeight: 44 },
  summaryUnit: { fontSize: 16, color: 'rgba(255,255,255,0.85)', marginBottom: 6 },
  calendar: {
    marginHorizontal: 16,
    borderRadius: 16,
    overflow: 'hidden',
  ...
  newWorkoutBtnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
});
